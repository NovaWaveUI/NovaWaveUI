...
export type CheckboxLabelProps<T extends React.ElementType = 'span'> = Omit<
  TextProps<T>,
  'children'
> &
  RenderProps<CheckboxRenderProps>;

const CheckboxLabel = forwardRefWith.as<'span', CheckboxLabelProps<'span'>>(
  (props, ref) => {
...
CheckboxLabel.displayName = 'NovaWaveUI.CheckboxLabel';
