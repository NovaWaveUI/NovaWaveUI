...
export const testButtonStyles = createNonSlotVariants({
  base: [
    'z-0',
    'group',
    'inline-flex',
...
export type TestButtonStyles = typeof testButtonStyles;
export type TestButtonVariantProps = ExtractVariantProps<TestButtonStyles>;
